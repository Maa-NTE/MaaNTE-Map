...
export const NAVIGATION_AUTO_COMPLETE_UPDATE_INTERVAL = 180
export const NAVIGATION_AUTO_COMPLETE_DEFAULT_RADIUS = 1.5
export const NAVIGATION_AUTO_COMPLETE_MIN_RADIUS = 0.1
export const NAVIGATION_AUTO_COMPLETE_MAX_RADIUS = 20
